...
REM set win7=yes
REM copy /y c:\windows\temp\analysis\HoboCopy64.exe c:\windows\temp\analysis\HoboCopy64.exe
REM )
...
FOR /F "tokens=*" %%G IN ('dir /b ^"C:\Users\*^"') DO HoboCopy64.exe "c:\Users\%%G" Registry\%%G NTUSER.DAT
REM FOR /F "tokens=*" %%G IN ('dir /b ^"C:\Users\*^"') DO HoboCopy64.exe "c:\Users\%%G\Local Settings\Application Data\Microsoft\Windows" Registry\%%G UsrClass.dat
...
.\HoboCopy64.exe "C:\WINDOWS\system32\config" Registry\ SAM
REM .\HoboCopy64.exe "C:\WINDOWS\system32\config" Registry\ SAM.log
REM .\HoboCopy64.exe "C:\WINDOWS\system32\config" Registry\ SAM.log1
REM .\HoboCopy64.exe "C:\WINDOWS\system32\config" Registry\ SAM.log2

echo.
echo Copying Security Hive and logs
.\HoboCopy64.exe "C:\WINDOWS\system32\config" Registry\ SECURITY
REM .\HoboCopy64.exe "C:\WINDOWS\system32\config" Registry\ SECURITY.log
REM .\HoboCopy64.exe "C:\WINDOWS\system32\config" Registry\ SECURITY.log1
REM .\HoboCopy64.exe "C:\WINDOWS\system32\config" Registry\ SECURITY.log2

echo.
echo Copying Software Hive and logs
.\HoboCopy64.exe "C:\WINDOWS\system32\config" Registry\ SOFTWARE
REM .\HoboCopy64.exe "C:\WINDOWS\system32\config" Registry\ SOFTWARE.log
REM .\HoboCopy64.exe "C:\WINDOWS\system32\config" Registry\ SOFTWARE.log1
REM .\HoboCopy64.exe "C:\WINDOWS\system32\config" Registry\ SOFTWARE.log2

echo.
echo Copying System Hive and logs
.\HoboCopy64.exe "C:\WINDOWS\system32\config" Registry\ SYSTEM
REM .\HoboCopy64.exe "C:\WINDOWS\system32\config" Registry\ SYSTEM.log
REM .\HoboCopy64.exe "C:\WINDOWS\system32\config" Registry\ SYSTEM.log1
REM .\HoboCopy64.exe "C:\WINDOWS\system32\config" Registry\ SYSTEM.log2

echo.
echo Copying Default Hive file and logs
.\HoboCopy64.exe "C:\WINDOWS\system32\config" Registry\ default
REM .\HoboCopy64.exe "C:\WINDOWS\system32\config" Registry\ default.log
REM .\HoboCopy64.exe "C:\WINDOWS\system32\config" Registry\ default.log1
REM .\HoboCopy64.exe "C:\WINDOWS\system32\config" Registry\ default.log2

echo.
echo Copying Components file, logs, bif, regtrans-ms
.\HoboCopy64.exe "C:\WINDOWS\system32\config" Registry\ components
REM .\HoboCopy64.exe "C:\WINDOWS\system32\config" Registry\ components.log
REM .\HoboCopy64.exe "C:\WINDOWS\system32\config" Registry\ components.log1
REM .\HoboCopy64.exe "C:\WINDOWS\system32\config" Registry\ components.log2
REM .\HoboCopy64.exe "C:\WINDOWS\system32\config" Registry\ components*.bif
REM .\HoboCopy64.exe "C:\WINDOWS\system32\config" Registry\ components*1.regtrans-ms
REM .\HoboCopy64.exe "C:\WINDOWS\system32\config" Registry\ components*2.regtrans-ms

echo.
echo Copying BCD-Template and logs
.\HoboCopy64.exe "C:\WINDOWS\system32\config" Registry\ BCD-Template
REM .\HoboCopy64.exe "C:\WINDOWS\system32\config" Registry\ BCD-Template.log
REM .\HoboCopy64.exe "C:\WINDOWS\system32\config" Registry\ BCD-Template.log1
REM .\HoboCopy64.exe "C:\WINDOWS\system32\config" Registry\ BCD-Template.log2
...
.\HoboCopy64.exe /full /y /recursive /skipdenied "C:\WINDOWS\system32\config\Journal" Registry\Journal\ *
echo.
echo Copying RegBack
.\HoboCopy64.exe /full /y /recursive /skipdenied "C:\WINDOWS\system32\config\regback" Registry\Regback\ *
echo.
REM ##############################################################################################################################
echo Copying SystemProfile
.\HoboCopy64.exe /full /y /recursive /skipdenied "C:\WINDOWS\system32\config\systemprofile" Registry\systemprofile\ *
echo.
echo Copying TxR
.\HoboCopy64.exe /full /y /recursive /skipdenied "C:\WINDOWS\system32\config\TxR" Registry\TxR\ *
...
del "c:\windows\temp\kludge-win7x64.bat.lck"
...
FOR /F "tokens=*" %%L IN (%1) DO echo.N|copy /-y NUL "%%L">NUL&&(
	...
	echo "%xfilepath%"
	echo %%L
	echo .\HoboCopy64.exe /y /skipdenied "C:\%xfilepath%" "%2\%xfilepath%" "%%~nL%%~xL"
	.\HoboCopy64.exe /y /skipdenied "C:\%xfilepath%" "%2\%xfilepath%" "%%~nL%%~xL"
	set xfilepath=
)
GOTO :eof
...
REM echo FOR /F "tokens=*" %%G IN (C:\Windows\Temp\analysis\finallyclean.txt) DO .\HoboCopy64.exe "C:\Users\%%G" "%3\%%G\ %2"
REM FOR /F "tokens=*" %%G IN (C:\Windows\Temp\analysis\finallyclean.txt) DO .\HoboCopy64.exe "C:\Users\%%G" "%3\%%G\ %2"
REM del C:\Windows\Temp\analysis\lockedfiles.txt
REM del C:\Windows\Temp\analysis\newpath.txt
REM del C:\Windows\Temp\analysis\newpath2.txt
REM del C:\Windows\Temp\analysis\finallyclean.txt
